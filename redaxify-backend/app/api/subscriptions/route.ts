...
export async function POST(req: Request) {
  try {
    ...
    const realCustomerNumber = user?.customerNumber;
    ...
    logActivity({
      activityType: "checkout_initiated",
      description: `User ${user.email} initiated checkout for plan '${plan.name}'`,
      customerNumber: realCustomerNumber,
      userAgent: req.headers.get("user-agent") || "",
      ipAddress: req.headers.get("x-forwarded-for") || "", // fallback IP
    });
