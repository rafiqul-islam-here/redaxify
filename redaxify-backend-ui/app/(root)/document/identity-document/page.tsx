...
const IdentityPage = () => {
    ...
    const handleUploadDocument = async (folderId: number, file: File) => {
        ...
        if (!validBankStatementTypes.includes(file.type)) {
            toast.error(
                'Unsupported file type. Only PDF, images (JPEG/JPG, PNG, BMP, TIFF, HEIF), and Office documents (DOCX, XLSX, PPTX) allowed.',
            );
            return;
        }
                    ...
                    <div className='absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-[#1C1C3A]/90 to-[#242648]/90 p-8'>
                        <div className='text-center max-w-md'>
                            ...
                            <p className='text-gray-300 mb-6'>
                                Upload a new Identity Document document or
                                select one from your folders.
                            </p>
                                                ...
                                                {folders.map(folder => (
                                                    ...
                                                    >
                                                        ...
                                                        <input
                                                            ...
                                                            type='file'
                                                            accept={validBankStatementTypes.join(
                                                                ',',
                                                            )}
                                                            className='hidden'
                                                            onChange={e => {
                        ...
                        <div className='mt-12 grid grid-cols-3 gap-6 max-w-2xl mx-auto'>
                            <div className='bg-[#1E1E3A]/50 p-4 rounded-lg border border-[#2E2E5A] text-center'>
                                ...
                                <p className='text-gray-400 text-sm'>
                                    PDF, Images: JPEG/JPG, PNG, BMP, TIFF, HEIF;
